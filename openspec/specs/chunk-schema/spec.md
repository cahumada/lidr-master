...
resuelve como `3`, pero **contado y logueado**: 18 filas en la corrida medida, y
si una futura trae más, eso tiene que verse. Un valor fuera del catálogo NO se
normaliza a nada.
...
<!-- Promovido de: add-window-status-metadata -->
